...
class DatabaseHelper {
  ...
  Future<void> _seedInitialData(SharedPreferences prefs) async {
    // Only create default patient profile and empty settings
    // No sample medicines, records, or vitals — user starts with a clean slate
    await savePatients([
      Dependent(
        id: 'default_patient',
        name: '',
    ...
    await saveMedicines([]);
    await saveDoseRecords([]);
    await saveVitalReadings([]);
